...
api_key_test = '0QpjH9zc8rGRNh6CqbXVEhMMcc3Uf6rjJdzQqw2n8LaqnkPDCDZvCC7o5Y17GxFV'
api_secret_test = 'LB06VFehtxVz4a2rzVlEtF3iIiJIUYIwpVt2vwc0qgzqR5lcHUMOBCMHrW4G5gkK'
...
for coin in keywords:
    conn_key = bsm.symbol_ticker_socket(coin+PAIRING)
# bsm.start()
